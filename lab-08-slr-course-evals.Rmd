...
evals %>%
  ...
  ggtitle("Scatterplot of Average Beauty Rating to Average Eval Score")
  

```
***There is positive correlation between Average Beauty and Average Eval Score***
...
***For an average beauty rating of 0 the average evaluation is 3.88.***
...
***This doesn't make sense in the data as there are no beauty ratings that are 0***
...
***For Males, the equation is `score = 4.09 + 0.14 = 4.23`***
***For Females, the equation is `score = 4.09`***
...
```
***the model is:***
***score = 4.28 - 0.12 x Tenure Track - 0.18 x Tenured***

***The average rating for a teaching track professor is 4.28, while the average for a tenure track professor is 4.16, and for a tenured professor, it's 4.14.***
...
***The average rating for tenured professor is 4.14, the average for a teaching prof is 0.14 points higher than that, and for a tenure track professor is 0.02 higher than a tenured professor.***
